...
int main(int argc, const char* argv[]) {
    ...
    if ( argc != 3 ) {
        cout << "Usage: generateLmtMaEvalGridWithOpenSim inputDirectory outputDirectory\n";
        cout << "inputDirectory:  directory containing angles.in (list of the angle configurations), muscles.in (list of muscles to consider for each coordinate), and model.osim files \n";
